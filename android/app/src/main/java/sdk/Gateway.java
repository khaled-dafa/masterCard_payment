...
public class Gateway extends com.mastercard.gateway.android.sdk.Gateway {
     ...
     */
    public com.mastercard.gateway.android.sdk.Gateway setMerchantId(String merchantId) {
        if (merchantId == null) {
     ...
     * @throws IllegalArgumentException If the provided Merchant ID is null
     */
    public com.mastercard.gateway.android.sdk.Gateway setRegion(Region region) {
        if (region == null) {
...
//     * {@link com.mastercard.gateway.android.sdk.Gateway#start3DSecureActivity(Activity, String, String)} method.
//     *
...
//     * @see com.mastercard.gateway.android.sdk.Gateway#start3DSecureActivity(Activity, String)
//     * @see com.mastercard.gateway.android.sdk.Gateway#start3DSecureActivity(Activity, String, String)
//     */
...
//     * {@link com.mastercard.gateway.android.sdk.Gateway#requestGooglePayData(PaymentsClient, PaymentDataRequest, Activity)} method.
//     *
//     * @param requestCode The request code returning from the activity result
//     * @param resultCode The result code returning from the activity result
//     * @param data The intent data returning from the activity result
...
//     * @return True if handled, False otherwise
//     * @see com.mastercard.gateway.android.sdk.Gateway#requestGooglePayData(PaymentsClient, PaymentDataRequest, Activity)
//     */
