...
//        // bind buttons
//        binding.startButton.setOnClickListener(v -> collectCardInfo());
...
//            showResult(R.drawable.failed, R.string.pay_error_unable_to_update_session);
    ...
    static class Check3DSecureEnrollmentCallback implements ApiController.Check3DSecureEnrollmentCallback {
        @Override
        public void onSuccess(GatewayMap response) {
            int apiVersionInt = 39;
...
//            showResult(R.drawable.failed, R.string.pay_error_3ds_authentication_failed);
   ...
   static class CompleteSessionCallback implements ApiController.CompleteSessionCallback {
        @Override
        public void onSuccess(String result) {
            Log.d("KHALED ERROR COMPLETE", "SUCCESS COMPLETE");
//            binding.processPaymentProgress.setVisibility(View.GONE);
...
//            showResult(R.drawable.success, R.string.pay_you_payment_was_successful);
        ...
        public void onError(Throwable throwable) {
            Log.e(ProcessPaymentActivity.class.getSimpleName(), throwable.getMessage(), throwable);
            Log.d("KHALED ERROR COMPLETE", throwable.getMessage(), throwable);
//            binding.processPaymentProgress.setVisibility(View.GONE);
